  ...
  if (soKm <= 1) {
    ...
    document.getElementById("modal-body").innerHTML = `<div class="table-responsive py-5">
        <table class="table table-primary hoa-don-ne">
          <thead>
            <tr>
              <th colspan=" 4" scope="col">CHI TIẾT HÓA ĐƠN <br>LOẠI XE: ${loaiXe}</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <td>${kmDaDi1}</td>
              <td>${tiemKiemGiaTienKmDauTien(loaiXe)} đ</td>
              <td>${chang1} đ</td>
            </tr>
            <tr>
        ...
        <table class="table table-primary hoa-don-ne">
          ...
          <tbody>
            ...
            <tr>
              <td scope="row">TỪ 1 ĐẾN 19 KM</td>
              <td>${kmDaDi2}</td>
              <td>${timKiemGiaTienTu1Den19(loaiXe)} đ</td>
              <td>${chang2} đ</td>
            </tr>
            <tr>
              <td scope="row">TỪ 19KM TRỞ LÊN</td>
        ...
        <table class="table table-primary hoa-don-ne">
          ...
          <tbody>
            ...
            <tr>
              <td scope="row">TỪ 19KM TRỞ LÊN</td>
            <td>${kmDaDi3}</td>
              <td>${timKiemGiaTienTu19TroLen(loaiXe)} đ</td>
              <td>${chang3} đ</td>
            </tr>
            <tr>
            <td scope="row">THỜI GIAN CHỜ</td>
